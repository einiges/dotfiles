...
hash -d bsp="$XDG_CONFIG_HOME"/bspwm
hash -d polybar="$XDG_CONFIG_HOME"/polybar

hash -d publ=~/prjects/public
hash -d priv=~/projects/private
hash -d silly=~/projects/silly
